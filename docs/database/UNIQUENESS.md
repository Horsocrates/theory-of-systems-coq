...
Дата сборки: 2026-06-09. Охват БД: **562 файла / 7580 Qed** каталогизировано (из 1639 / ~23 100 в репо)._
...
_Полный по-файловый каталог: `docs/database/INDEX.md` (562 файла) + `_uniqueness_ranked.md` (по убыванию score).

(* ========================================================================= *)
(*        ORDERED-FIELD LAWS ON REAL PROCESSES (mul, inverse)              *)
(*                                                                         *)
(*  Part of: Theory of Systems - Coq Formalization (E/R/R Framework)       *)
(*                                                                         *)
(*  PURPOSE: Extend CauchyReal.v with multiplication, multiplicative       *)
(*  inverse, and the ordered-field LAWS on Cauchy processes (up to the     *)
(*  process equivalence ~~).                                               *)
(*                                                                         *)
(*  ONTOLOGY (E/R/R / P4): this establishes the FIELD STRUCTURE carried    *)
(*  by real PROCESSES — the operations and their laws, each step finitely  *)
(*  actualizable. It does NOT build a completed object "R": under P4 a      *)
(*  real is a process (nat -> Q), never a finished set; the laws are       *)
(*  forall-RULES over the process type, not a claim that "all reals" form  *)
(*  one object. (Cf. Q: enumerable by a rule, not a set of some "size".)   *)
(*                                                                         *)
(*  CONTENTS:                                                              *)

...
(*                                                                          *)
(*  STATUS: 0 Admitted (all previously Admitted are now Qed or weakened)    *)
(*          update_increases_size: CLOSED                                   *)
(*          no_self_level_elements: CLOSED (statement weakened)             *)
(*          cantor_no_system_of_all_L2_systems: CLOSED (statement weakened) *)

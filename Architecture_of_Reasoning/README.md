...
│
├── AI_FallacyDetector.v             # AI Application (657 lines)
...
│
├── ParadoxDissolution.v             # Paradox analysis (770 lines)
...
│
├── ERR_Fallacies.v                  # E/R/R Framework (890+ lines)
...
|------|-------|----------|----------|
| `CompleteFallacyTaxonomy.v` | 530 | 19 | **0** |

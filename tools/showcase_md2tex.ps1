# showcase_md2tex.ps1 - Markdown -> LaTeX for docs/SHOWCASE.md
# Targets the approved Tom II book stack (T2A/cm-super, babel-russian, listings, booktabs).
# ASCII-only source; all Unicode symbols built from codepoints (PowerShell 5.1 reads .ps1 as ANSI).
$ErrorActionPreference = 'Stop'
$root = "C:\Users\abary\OneDrive\Desktop\theory-of-systems-coq"
$src  = Join-Path $root "docs\SHOWCASE.md"
$dst  = Join-Path $root "docs\SHOWCASE.tex"

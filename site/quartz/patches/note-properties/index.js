  ...
  const targetSlug = transformInternalLink(target);
  {
    ...
    const [targetCanonical, targetAnchor] = splitAnchor(canonicalSlug);
    {
      ...
      const matchingFileNames = opts.allSlugs.filter((slug2) => {
        ...
        // PATCH (2026-07-16): одно-сегментная цель матчит ПАПКУ по её имени (слаг кончается на /index)
        return fileName === "index" && parts.length >= 2 && targetCanonical === parts.at(-2);
      });
      ...
      "details",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ u2("table", { class: "note-properties-table", children: /* @__PURE__ */ u2("tbody", { children: entries.map(([key, value2]) => /* @__PURE__ */ u2("tr", { class: "note-properties-row metadata-property", children: [
            /* @__PURE__ */ u2("td", { class: "note-properties-key metadata-property-key", children: ({ description: "Описание", tags: "Теги", aliases: "Синонимы" })[key] ?? key }),

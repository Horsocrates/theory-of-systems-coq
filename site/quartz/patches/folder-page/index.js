...
function byDateAndAlphabeticalFolderFirst(_cfg) {
  return (f1, f22) => {
    ...
    if (!f1IsFolder && f2IsFolder) return 1;
    const f1Key = ((f1.slug ?? "").split("/").filter((s) => s.length > 0 && s !== "index").pop() ?? "");
    const f2Key = ((f22.slug ?? "").split("/").filter((s) => s.length > 0 && s !== "index").pop() ?? "");
    return f1Key.localeCompare(f2Key, undefined, { numeric: true, sensitivity: "base" });
  };
}
...
var PageList = ({
  ...
  return /* @__PURE__ */ u2("ul", { class: "section-ul", children: list.map((page) => {
    ...
    return /* @__PURE__ */ u2("li", { class: "section-li", children: /* @__PURE__ */ u2("div", { class: "section", children: [
      /* @__PURE__ */ u2("p", { class: "meta", children: false && /* @__PURE__ */ u2(
        DateDisplay,
        {
          date: getDate(page),
...
var suppressedFolderPages = ["библиотека/направления/математика/том-математика"];
function pagesFromTrie(folder, showSubfolders) {
  return folder.children.map((node) => {
    ...
    if (node.isFolder && showSubfolders) {
      if (suppressedFolderPages.includes((node.slug ?? "").replace(/\/index$/, ""))) return void 0;
      return {
        slug: node.slug,
...
function pagesFromAllFiles(allFiles, folderSlug, showSubfolders) {
  ...
  for (const [subfolderName, files] of subfolderFiles) {
    ...
    if (suppressedFolderPages.includes(`${folderPrefix}${subfolderName}`)) continue;
    directChildren.push({
  ...
  return {
    ...
    generate({ content, cfg }) {
      ...
      for (const folder of folders) {
        ...
        if (suppressedFolderPages.includes(folder)) continue;

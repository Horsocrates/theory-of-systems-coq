...
var Breadcrumbs_default = ((opts) => {
  ...
  const Breadcrumbs = ({
    ...
    const suppressedFolderPages = ["библиотека/направления/математика/том-математика"];
    const crumbs = pathNodes.map((node, idx) => {
      ...
      if (idx !== pathNodes.length - 1 && suppressedFolderPages.includes((node.slug ?? "").replace(/\/index$/, ""))) {
        crumb.path = null;
      }
      return crumb;
    });
    ...
    return /* @__PURE__ */ u2("nav", { class: classNames(displayClass, "breadcrumb-container"), "aria-label": "breadcrumbs", children: crumbs.map((crumb, index) => /* @__PURE__ */ u2("div", { class: "breadcrumb-element", children: [
      crumb.path === null ? /* @__PURE__ */ u2("span", { children: crumb.displayName }) : /* @__PURE__ */ u2("a", { href: crumb.path, children: crumb.displayName }),
